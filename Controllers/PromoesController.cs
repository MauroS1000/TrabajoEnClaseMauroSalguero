...
namespace TrabajoEnClaseMauroSalguero.Controllers
{
    public class PromoesController : Controller
    {
        ...
        public PromoesController(TrabajoEnClaseMauroSalgueroContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Promo != null ? 
                          ...
                          Problem("Entity set 'TrabajoEnClaseMauroSalgueroContext.Promo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TrabajoEnClaseMauroSalgueroContext.Promo'  is null.");
            }
            var promo = await _context.Promo.FindAsync(id);
            if (promo != null)
            {
