...
namespace TrabajoEnClaseMauroSalguero.Controllers
{
    public class BurgersController : Controller
    {
        private readonly TrabajoEnClaseMauroSalgueroContext _context;

        public BurgersController(TrabajoEnClaseMauroSalgueroContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'TrabajoEnClaseMauroSalgueroContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TrabajoEnClaseMauroSalgueroContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
